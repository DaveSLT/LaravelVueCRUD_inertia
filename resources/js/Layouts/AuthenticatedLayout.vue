            ...
            <nav class="border-b border-gray-200 bg-white">
                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex h-16 items-center justify-between">
                        ...
                        <div class="flex items-center space-x-4">
                            <!-- User Dropdown (Hidden on Small Screens) -->
                            ...
                            <button
                                @click="
                                    showingNavigationDropdown =
                                        !showingNavigationDropdown
                                "
                                class="sm:hidden inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none"
                            >
                                <svg
                                    class="h-6 w-6"
                                    xmlns="http://www.w3.org/2000/svg"
                ...
                >
                    <div class="space-y-1 pb-3 pt-2">
                        ...
                        <ResponsiveNavLink
                            :href="route('shop')"
                            :active="route().current('shop')"
                            >Shop</ResponsiveNavLink
                        >
                        <ResponsiveNavLink
                            :href="route('myaccount')"
                            :active="route().current('myaccount')"
                            >My Account</ResponsiveNavLink
                        >
                        <ResponsiveNavLink
                            :href="route('support')"
                            :active="route().current('support')"
                            >Support</ResponsiveNavLink
                        >
                    </div>
