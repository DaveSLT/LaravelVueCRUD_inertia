...
// Map of camera names to images
const cameraImages = {
    "Canon EOS R5": Canon_EOS_R5,
    "Sony A7 III": Sony_A7_III,
    "Nikon Z6": Nikon_Z6,
    "Fujifilm X-T4": Fujifilm_X_T4,
    "Panasonic Lumix GH5": Panasonic_Lumix_GH5,
    "Blackmagic Pocket 6K": Blackmagic_Pocket_6K,
};

// Function to get camera image by name
const getCameraImage = (cameraName) => cameraImages[cameraName] || "";
...
const filteredCamerasWithImages = computed(() => {
    return props.cameras
        ...
        .map((camera) => ({
            ...camera,
            image: getCameraImage(camera.camera_name), // Attach image to camera data
        }));
});
</script>
